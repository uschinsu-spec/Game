/**
 * ============================================================================
 * 🏛️ THÔN TRẤN 3D ASSET MODULE: Floor_RedBrick
 * ============================================================================
 * Category: Sàn Nhà (floors)
 * Dimensions: 2.0m x 0.02m x 2.0m | Vertices: 8 | Faces: 4
...
(function(global) {
  ...
  const MODEL_NAME = 'Floor_RedBrick';
  const SUBMESHES = [{"matName":"MI_RedBrick","texture":"T_RedBrick_BaseColor.png","doubleSided":true,"isUint32":false,"pos":"AACAvwDXIzwAAIA/AACAPwDXIzwAAIA/AACAvwDXIzwAAIC/AACAPwDXIzwAAIC/AACAP1nVI7wAAIA/AACAvxTYI7wAAIA/AACAP+zVI7wAAIC/AACAv6fYI7wAAIC/","norm":"AAAAAAAAgD8AAACAAAAAAAAAgD8AAACAAAAAAAAAgD8AAACAAAAAAAAAgD8AAACAAAAAAAAAgL8AAAAAAAAAAAAAgL8AAAAAAAAAAAAAgL8AAAAAAAAAAAAAgL8AAAAA","uv":"AAAAAAAAgD8AAIA/AACAPwAAAAAAAAAAAACAPwAAAAAAAIA/AACAPwAAAAAAAIA/AACAPwAAAAAAAAAAAAAAAA==","indices":"AQADAAIAAQACAAAABQAHAAYABQAGAAQA"}];
